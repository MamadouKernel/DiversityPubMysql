# Script PowerShell fonctionnel pour backup de structure MySQL
param(
    [string]$Commentaire = "",
    [string]$OutputPath = "Backups"
)

Write-Host "=== Backup fonctionnel de la base de données DiversityPub ===" -ForegroundColor Green
...
try {
    $sqlLines | Out-File -FilePath $backupFilePath -Encoding UTF8
    ...
    $metadata = @{
        ...
        Method = "Script PowerShell fonctionnel"
    }
...
Write-Host "=== Backup fonctionnel terminé ===" -ForegroundColor Green
