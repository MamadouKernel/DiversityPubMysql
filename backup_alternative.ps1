# Script PowerShell alternatif pour backup de la base de données DiversityPub
# Utilise Entity Framework pour exporter les données sans mysqldump
...
Write-Host "=== Backup alternatif de la base de données DiversityPub ===" -ForegroundColor Green
...
try {
    ...
    $metadata = @{
        ...
        Method = "Script PowerShell alternatif"
    }
...
Write-Host "=== Backup alternatif terminé ===" -ForegroundColor Green
